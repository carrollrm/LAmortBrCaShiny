...
modelAFT$summary=read.csv("data\\modelAFTSPTPRED9o10.csv")[,-1]
  ...
  output$text <- renderText({
    paste("The plot below displays the survival probability curve for total mortality 
          ...
          ifelse(input$grade==TRUE,"Well or moderately defined,",
            "poorly defined, undefined, or of unknown definition,")," she ",
          ifelse(input$er=="Positive" & input$pr=="Positive","was ER and PR positive",
          ifelse(input$er=="Positive" & input$pr=="Negative","was ER positive and PR negative",
          ifelse(input$er=="Negative" & input$pr=="Positive","was ER negative and PR positive",
          ifelse(input$er=="Unknown" & input$pr=="Positive","was PR positive with an unknown ER status"),
          ifelse(input$er=="Positive" & input$pr=="Unknown","was ER positive with an unknown PR status"),
          ifelse(input$er=="Unknown" & input$pr=="Unknown","had unknown ER and PR statuses"),
            "was ER and PR negative"))),", and ",
